...
def get_finalblock_max_size():
    return (14 + 2*MAX_NUM_PICKABLE_REGS + 2*MAX_NUM_PICKABLE_FLOATING_REGS - 1) * 4
...
def finalblock(fuzzerstate, design_name: str):
    ...
    lui_imm_regdump, addi_imm_regdump = li_into_reg(regdump_addr, False)
    ...
    lui_imm_stopreq, addi_imm_stopreq = li_into_reg(stopsig_addr, False)
